...
public class Department
{
    ...
    public Department(string name, long nationalCode, long postalCode, string address, string logo, string logoAlt, string logoTitle, string slug)
    {
        Name = name;
    ...
    public void Edit(string name, long nationalCode, long postalCode, string address, string logo, string logoAlt, string logoTitle, string slug)
    {
        Name = name;
        NationalCode = nationalCode;
        PostalCode = postalCode;
